...
//           alert("t");
    var currentRow = $(this).closest('tr');
    var NodeId = $(this).closest('tr').attr('id');
    var NodeName = currentRow.find('td:eq(1)').text();
    var ip = currentRow.find('td:eq(2)').text();
    var des = currentRow.find('td:eq(3)').text();
        ...
        alarm_type: alarm_type
            ...
            function (response) {
                if (response !== "failed") {
                    ...
                    var t;
                    if (NodeId === "0")
                        t = document.createTextNode("Added " + NodeName + " Successfully");
                    else
                        t = document.createTextNode("Updated " + NodeName + " Successfully");
                    para.appendChild(t);
