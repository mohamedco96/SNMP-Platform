...
import com.iti.snmp_client.IssueInfo;
import com.iti.snmp_client.SnmpTrapInfo;
...
VariableBinding vb = varIter.next();
            ...
            DataBase connection=new DataBase();
             Gson g=new Gson();
            SnmpTrapInfo p=g.fromJson(vb.getVariable().toString(),SnmpTrapInfo.class);
            IssueInfo p1 =p.getIssueInfo();
            try {
                connection.insert_alarm(p1.getNode_IP(),vb.getOid()+"",p.getTrapType(),p1.getDescription()+"",p.isState());
